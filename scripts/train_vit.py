"""
Training script for Vision Transformer (ViT/EVA02) on ISIC 2024.
...
# Custom modules
from src.models.vit_classifier import ViTClassifier, FocalLoss, MODEL_CONFIGS
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train ViT for ISIC 2024')
    ...
    parser.add_argument('--lr_backbone', type=float, default=1e-5,
                       help='Learning rate for backbone (lower than head)')
    ...
    parser.add_argument('--fold', type=int, default=None,
                       help='Train specific fold (None = all folds)')
...
def train_fold(
    ...
    Args:
        fold: Fold number
        df_train: Training dataframe with fold column
    ...
    for epoch in range(args.epochs):
        ...
        # Update model epoch (for unfreezing backbone)
...
def main():
    ...
    print("="*80)
    print("ISIC 2024 - Vision Transformer Training")
    print("="*80)
    print(f"\nConfiguration:")
